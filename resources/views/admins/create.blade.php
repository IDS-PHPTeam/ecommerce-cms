...
@section('content')
<div class="card">
    <h2 style="margin-bottom: 1.5rem; font-size: 1.875rem; font-weight: 700;">{{ __('cms.add_new_admin') }}</h2>
    ...
    <form method="POST" action="{{ route('admins.store') }}">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
            <div class="form-group">
                <label for="password" class="form-label">{{ __('cms.password') }} <span style="color: #ef4444;">*</span></label>
            ...
            <div class="form-group">
                <label for="password_confirmation" class="form-label">{{ __('cms.confirm_password') }} <span style="color: #ef4444;">*</span></label>
