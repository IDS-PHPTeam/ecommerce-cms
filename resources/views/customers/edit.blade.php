...
@section('content')
<div class="card">
    <h2 class="section-heading-lg mb-6">Edit Customer</h2>
    ...
    <form method="POST" action="{{ route('customers.update', $customer) }}" enctype="multipart/form-data" id="customerForm">
        ...
        <!-- Tabs Navigation -->
        <div class="tabs-nav border-b-2 border-gray-200 mb-6 overflow-x-auto">
        ...
        <div id="generalTab" class="tab-content active d-block">
        ...
        <div class="form-group">
            ...
            @if($customer->profile_image)
                <div class="mb-4">
                    <img src="{{ asset('storage/' . $customer->profile_image) }}" alt="Profile" class="max-w-150 max-h-150 rounded-full border-2 border-gray-200 object-cover d-block">
                    <label class="flex-center-y gap-2 mt-2 cursor-pointer">
                        <input type="checkbox" name="delete_current_image" value="1">
                        <span class="text-red-500 text-sm">Delete current image</span>
                    </label>
                </div>
            @endif
            ...
            <div id="imagePreview" class="mt-4 d-none">
                <div class="relative d-inline-block">
                    <img id="previewImg" src="" alt="Preview" class="max-w-200 max-h-200 rounded-full border-2 border-gray-200 object-cover d-block">
                    <button type="button" id="removeImageBtn" class="absolute top-2 right-2 bg-red-500 text-white border-0 rounded-full cursor-pointer flex-center w-8 h-8 shadow-md z-10" title="Remove image">
        ...
        <div id="imageSelectionModal" class="modal-overlay d-none">
            <div class="modal-content max-w-90vw max-h-90vh p-0">
                ...
                <div class="flex border-b border-gray-200">
                    <button type="button" class="image-tab-btn active" data-tab="media">Select from Media</button>
                    <button type="button" class="image-tab-btn" data-tab="upload">Select from PC</button>
                </div>

                <!-- Tab Content -->
                <div class="modal-body modal-body-scroll p-6">
                    <!-- Media Tab -->
                    <div id="mediaTab" class="tab-content d-block">
                        <div id="mediaGrid" class="grid grid-auto-150 gap-4">
                            <div class="text-center p-8 text-tertiary col-span-full">Loading images...</div>
                        </div>
                    </div>
                    ...
                    <div id="uploadTab" class="tab-content d-none">
                        <div class="text-center p-8">
                            <input type="file" id="modalFileInput" accept="image/*" class="form-input max-w-400 mx-auto">
        ...
        <!-- Tab 2: Addresses -->
        <div id="addressesTab" class="tab-content d-none">
            <div class="form-group">
                ...
                <div id="addressesContainer" class="mb-2">
                    ...
                    @if(count($addresses) > 0)
                        @foreach($addresses as $index => $address)
                            <div class="address-item card card-sm mb-2 bg-gray-50" data-address-index="{{ $index }}">
                                <div class="flex justify-between items-center mb-4">
                                    <h4 class="text-base font-semibold text-primary">Address {{ $index + 1 }}</h4>
                                    <button type="button" class="remove-address-btn btn btn-danger-sm">Remove</button>
                                </div>
                                <div class="grid grid-auto-200 gap-4">
                                    <div class="form-group">
                        ...
                        @endforeach
                    @else
                        <div class="address-item card card-sm mb-2 bg-gray-50" data-address-index="0">
                            <div class="flex justify-between items-center mb-4">
                                <h4 class="text-base font-semibold text-primary">Address 1</h4>
                                <button type="button" class="remove-address-btn btn btn-danger-sm d-none">Remove</button>
                            </div>
                            <div class="grid grid-auto-200 gap-4">
                                <div class="form-group">
                                    <label class="form-label">Label (e.g., Home, Work)</label>
                ...
                <button type="button" id="addAddressBtn" class="btn bg-gray-600 text-white mt-2">Add Address</button>
